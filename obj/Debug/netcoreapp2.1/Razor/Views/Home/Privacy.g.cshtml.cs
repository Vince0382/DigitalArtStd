#pragma checksum "/Users/vince/Google Drive/Sources/DigitalArtStd/DigitalArtStd/Views/Home/Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "01fd3162d33ffa74f2fbbee27d3ddc5d42eef85c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"01fd3162d33ffa74f2fbbee27d3ddc5d42eef85c", @"/Views/Home/Privacy.cshtml")]
    ...
    public class Views_Home_Privacy : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "/Users/vince/Google Drive/Sources/DigitalArtStd/DigitalArtStd/Views/Home/Privacy.cshtml"
...
<div class=""text-center privacyContainer spacerTop"" id=""main"">
    <h2>");
            EndContext();
            BeginContext(457, 17, false);
#line 26 "/Users/vince/Google Drive/Sources/DigitalArtStd/DigitalArtStd/Views/Home/Privacy.cshtml"
   Write(ViewData["Title"]);

#line default
#line hidden
            EndContext();
            BeginContext(474, 16792, true);
            WriteLiteral(@"</h2>
    <div id='ppBody'>
        ...
        <div style=");
            WriteLiteral(@"'clear:both;height:10px;'></div>
        ...
        <div class='innerText'>When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, mailing address, phone number ");
            WriteLiteral(@" or other details to help you with your experience.</div>
        <br>
        ...
        <div cl");
            WriteLiteral(@"ass='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To improve our website in order to better serve you.</div>
        ...
        <div class='innerText'>We use ");
            WriteLiteral(@"regular Malware Scanning.<br><br></div>
        ...
        <br />
        <div class='innerText'>Yes. Cookies are small files that a site or its service provider transfers to your comp");
            WriteLiteral(@"uter's hard drive through your Web browser (if you allow) that enables the site's or service provider's systems to recognize your browser and capture and remember certain information. For instance, we use cookies to help us remember and process the items in your shopping cart. They are also used to help us understand your preferences based on previous or current site activity, which enables us to provide you with improved services. We also use cookies to help us compile aggregate data about site traffic and site interaction so that we can offer better site experiences and tools in the future.</div>
        ...
        <div class='innerText'><br>You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your brows");
            WriteLiteral(@"er settings. Since browser is a little different, look at your browser's Help Menu to learn the correct way to modify your cookies.<br></div>
        <br>
        ...
        <br />
        <div class='innerText'>We do not sell, trade, or otherwise transfer to outside parties your Personally Identifiable Information unless we provide users with advance notice. This does not include website hosting partners and other parties who assist us in operating our website, conducting our business, or serving our users, so long as those parties agree to keep this information confidential. We may also release information when it's release is appropriate to comply with the law, enforce our site policies, or protect ours or others' rights, property or safety. <br><br> However, non-personally identifiable visitor inform");
            WriteLiteral(@"ation may be provided to other parties for marketing, advertising, or other uses. </div>
        ...
        <di");
            WriteLiteral(@"v class='innerText'>We have not enabled Google AdSense on our site but we may do so in the future.</div>
        ...
        <div class='innerText'><br><strong>According to CalOPPA, we agree to the following:</strong>");
            WriteLiteral(@"<br></div>
        ...
        <div class='innerText'>We honor Do Not Track signals and Do No");
            WriteLiteral(@"t Track, plant cookies, or use advertising when a Do Not Track (DNT) browser mechanism is in place. </div>
        ...
        <div class='innerText'>We do not specifically market to children under ");
            WriteLiteral(@"the age of 13 years old.</div>
        ...
        <div class='innerText'>We will notify the");
            WriteLiteral(@" users via in-site notification</div>
        <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Within 1 business day</div>
        ...
        <br />
        <div class='innerText'>The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violatio");
            WriteLiteral(@"ns.<br><br></div>
        ...
        <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Include the physic");
            WriteLiteral(@"al address of our business or site headquarters.</div>
        ...
        <div class='innerText'>info@digitalartstd.com and we will promptly remove you from <strong>ALL</strong> correspondence.</div>
        <br><span id='ourCon'></span><br>
        <div class='blueText'><strong>Contacting Us</strong></div>
        <br />
        <div class='innerText'>If there are any questions regarding this priva");
            WriteLiteral(@"cy policy, you may contact us using the information below.<br><br></div>
        <div class='innerText'>digitalartstd.com</div>
        <div class='innerText'>30 rue d'audun</div>
        OTTANGE, FRANCE 57840
        <div class='innerText'>France</div>
        <div class='innerText'>info@digitalartstd.com</div>
        <div class='innerText'><br>Last Edited on 2018-06-10</div>
    </div>
</div>
");
            EndContext();
